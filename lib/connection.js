 ...
 * Check and put data
 * @param regionName region name
 * @param checkAndPut the data to be check and put
 * @throws IOException e
 */
Connection.prototype.checkAndPut = function (regionName, checkAndPut, callback) {
  this.call('checkAndPut', [
    regionName,
    checkAndPut.getRow(),
    checkAndPut.getFamily(),
    checkAndPut.getQualifier(),
    checkAndPut.getValue(),
    checkAndPut.getPut()
  ], callback);
};
 ...
 * @param regionName region name
 * @param checkAndDelete the data to be check and delete
 * @throws IOException e
 */
Connection.prototype.checkAndDelete = function (regionName, checkAndDelete, callback) {
  this.call('checkAndDelete', [
    regionName,
    checkAndDelete.getRow(),
    checkAndDelete.getFamily(),
    checkAndDelete.getQualifier(),
    checkAndDelete.getValue(),
    checkAndDelete.getDelete()
  ], callback);
};
