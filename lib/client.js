...
var CheckAndDelete = require('./check_and_delete');
var CheckAndPut = require('./check_and_put');
var Get = require('./get');
var Put = require('./put');
...
/**
 * @api https://hbase.apache.org/0.94/apidocs/org/apache/hadoop/hbase/client/HTableInterface.html#checkAndPut(byte[],%20byte[],%20byte[],%20byte[],%20org.apache.hadoop.hbase.client.Put)
 */
Client.prototype.checkAndPut = function (tableName, row, family, qualifier, value, put, callback) {
  var checkAndPut = new CheckAndPut(row, family, qualifier, value, put);
  this._action('checkAndPut', tableName, checkAndPut, true, 0, callback);
};

/**
 * @api https://hbase.apache.org/0.94/apidocs/org/apache/hadoop/hbase/client/HTableInterface.html#checkAndDelete(byte%5B%5D,%20byte%5B%5D,%20byte%5B%5D,%20byte%5B%5D,%20org.apache.hadoop.hbase.client.Delete)
 */
Client.prototype.checkAndDelete = function (tableName, row, family, qualifier, value, deleter, callback) {
  var checkAndDelete = new CheckAndDelete(row, family, qualifier, value, deleter);
  this._action('checkAndDelete', tableName, checkAndDelete, true, 0, callback);
};
