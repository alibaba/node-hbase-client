...
Client.prototype = {
        ...
        var getRegionInfo = function () {
          ...
          server.getClosestRowBefore(metaLocation.getRegionInfo().getRegionName(), metaKey, 
            ...
            if (regionInfoRow === null) {
              return callback(new TableNotFoundException(Bytes.toString(tableName)));
            }
  ...
  getHRegionConnection: function (hostname, port, callback, master) {
    ...
    var remoteId = new ConnectionId({
      host: hostname,
      port: port,
    }, 29, null, self.rpcTimeout);
    var connection = new Connection(remoteId);
   ...
   */
  getTableLocations: function (tableName) {
