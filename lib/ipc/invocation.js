...
var debug = require('debug')('hbase-client:invocation');
...
Invocation.prototype.getMethodName =function () {
  return this.methodName;
};

/** @return The parameter classes. */
Invocation.prototype.getParameterClasses = function () {
  return this.parameterClasses;
};

/** @return The parameter instances. */
Invocation.prototype.getParameters = function () {
  return this.parameters;
};

Invocation.prototype.getProtocolVersion = function () {
  return this.clientVersion;
};

Invocation.prototype.getClientMethodsHash = function () {
 ...
 * @return rpcVersion
 */
Invocation.prototype.getRpcVersion = function () {
  return RPC_VERSION;
};
