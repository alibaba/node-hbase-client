...
DataOutputBuffer.prototype.getData = function () {
  return Buffer.concat(this.buf, this.length);
};
...
DataOutputBuffer.prototype.write = function (b, offset, length) {
 ...
 */
DataOutputBuffer.prototype.writeByte = function (v) {
 ...
 * @see        java.io.FilterOutputStream#out
 */
DataOutputBuffer.prototype.writeBoolean = function (v) {
 ...
 * @see        java.io.FilterOutputStream#out
 */
DataOutputBuffer.prototype.writeShort = function (v) {
  this.writeChar(v);
};
 ...
 * @see        java.io.FilterOutputStream#out
 */
DataOutputBuffer.prototype.writeChar = function (v) {
 ...
 * @see        java.io.FilterOutputStream#out
 */
DataOutputBuffer.prototype.writeInt = function (v) {
 ...
 * @see        java.io.FilterOutputStream#out
 */
DataOutputBuffer.prototype.writeLong = function (v) {
...
DataOutputBuffer.prototype.writeBytes = function (bytes) {
  this.write(bytes);
};
